          ...
          <v-card class="pa-sm-5 mx-lg-auto" color="white" width="95%" elevation="15">
            <v-card-text>
              ...
              <v-form class="px-3" ref="form">
                ...
                <br />
                <v-autocomplete label="Expected Graduation Date?" :items="semesters" outlined dense></v-autocomplete>
                ...
                <v-autocomplete label="Check only ONE category." :items="graduation" outlined dense></v-autocomplete>
